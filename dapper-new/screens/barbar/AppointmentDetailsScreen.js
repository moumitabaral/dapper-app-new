                    ...
                    <View>
                        ...
                        <View style={{
                            ...
                            <View style={{flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginVertical: 10,}}>
                                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                                    <AntDesign name="calendar" size={18} color="#0088E0" />
                                    <Text style={{marginLeft: 5, fontSize: 16}}>{data.date}</Text>
                                </View>
                                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                                    <AntDesign name="clockcircleo" size={18} color="#0088E0" />
                    ...
                    <View>
                            ...
                            <>
                                ...
                                >
                                    { data.status == "APPROVE" ? (
                                            ...
                                            <Text style={{color: "#0088E0", fontSize: 16}}>Accept Appointment</Text>
                                        )
                                    }
                                </Button>
                        ...
                        {data.status != "PROGRESSING" && (
                            <Button 
                                ...
                                containerStyle={{marginTop: 20}}
                                buttonStyle={{backgroundColor: "#0088E0", borderRadius: 100}}
